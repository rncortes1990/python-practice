...
#  El objetivo es leer por pantalla un número >= que ini y <= que fin. Además a la hora de hacer la lectura 
#  se mostrará en el input el mensaje enviado a la función. Finalmente se devolverá el valor. Esta función 
#  tiene que devolver un número, y tiene que repetirse hasta que el usuario no lo escriba bien 
...
# no recibirá ningún parámetro. Dentro leerás dos números con la función leer_numero():

# El primer numero será llamado numeros, deberá ser entre 1 y 20, ambos incluidos, y 
# se mostrará el mensaje ¿Cuantos números quieres generar? [1-20]:
